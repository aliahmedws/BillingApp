...
const routes: Routes = [
  ...
  { path: 'bulk-electricity-bills', loadChildren: () => import('./bill/electricity-bill/bulk-electricity-bill/bulk-electricity-bill.module').then(m => m.BulkElectricityBillModule) }
