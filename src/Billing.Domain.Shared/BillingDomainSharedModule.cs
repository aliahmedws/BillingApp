...
public class BillingDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        BillingGlobalFeatureConfigurator.Configure();
        BillingModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<BillingDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<BillingResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Billing");

            options.DefaultResourceType = typeof(BillingResource);
        ...
        {
            options.MapCodeNamespace("Billing", typeof(BillingResource));
        });
    }
}
